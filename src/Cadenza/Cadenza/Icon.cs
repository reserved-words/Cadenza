...
public static class Icon
{
    ...
    public static string Pause = Icons.Material.Filled.Pause;
    public static string Play = Icons.Material.Filled.PlayArrow;
    ...
    public static string SkipNext = Icons.Material.Filled.SkipNext;
    public static string SkipPrevious = Icons.Material.Filled.SkipPrevious;
