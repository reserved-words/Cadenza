...
public interface IEditItemMapper
{
    ...
    List<EditableAlbumDisc> MapEditableAlbumTracks(IReadOnlyCollection<AlbumTrackVM> tracks);
    ...
    IReadOnlyCollection<AlbumTrackVM> MapEditedAlbumTracks(List<EditableAlbumDisc> tracks);
